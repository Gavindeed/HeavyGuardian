...
class ssummary
{
    public:
        int tot;
        int sum[ss_M+10],K,last[ss_M+10],Next[ss_M+10],ID[ss_M+10];
        int head[ss_N+10],Left[ss_N+10],Right[ss_N+10],num;
        string str[ss_M+10];
        int head2[len2+10],Next2[ss_M+10];
        BOBHash32 * bobhash;
        ...
        void clear()
        {
            ...
            rep(i,0,ss_N)head[i]=Left[i]=Right[i]=0;
            rep(i,0,len2-1)head2[0]=0;
            tot=0;
            rep(i,1,ss_M+2)ID[i]=i;
            num=ss_M+2;
            Right[0]=ss_N;
            Left[ss_N]=0;
        }
